...
public class TurtleActivity extends AppCompatActivity {
    ...
    private DatabaseReference first=databaseReference.child("turtle");
    private DatabaseReference txt=databaseReference.child("turtleText");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        info = findViewById(R.id.turtleInfo);
