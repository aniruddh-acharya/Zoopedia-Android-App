...
public class CartiActivity extends AppCompatActivity {
    ...
    private DatabaseReference first=databaseReference.child("carti");
    private DatabaseReference txt=databaseReference.child("cartiText");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        info = findViewById(R.id.cartiInfo);
