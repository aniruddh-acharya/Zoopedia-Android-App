...
public class FrogActivity extends AppCompatActivity {
    ...
    private DatabaseReference first=databaseReference.child("frog");
    private DatabaseReference txt=databaseReference.child("frogText");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        info = findViewById(R.id.frogInfo);
