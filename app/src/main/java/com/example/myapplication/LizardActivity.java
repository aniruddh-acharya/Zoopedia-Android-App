...
public class LizardActivity extends AppCompatActivity {
    ...
    private DatabaseReference first=databaseReference.child("lizard");
    private DatabaseReference txt=databaseReference.child("lizardText");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        info = findViewById(R.id.lizardInfo);
